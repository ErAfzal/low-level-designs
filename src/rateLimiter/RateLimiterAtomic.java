...
public class RateLimiterAtomic {
    //token bucket Rate Limiter using java
    //using AtomicInteger instead of int, it will reduce the use of synchronze block
    //incomplete
    ...
    public RateLimiterAtomic(int maxBucketSize, int refill) {
        this.maxBucketSize = maxBucketSize;
        this.refillTokens = refill;
        currentTokens=new AtomicInteger(maxBucketSize);
